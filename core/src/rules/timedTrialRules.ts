 ...
 */
import { WorldModel, endMatch } from "../worldModel.js";
import { isFullyInsideZone } from "../simulationEngine.js";

export function tickTimedTrialRules(world: WorldModel, robotId: string, dtMs: number): void {
  if (!world.match.started || world.match.ended) return;
